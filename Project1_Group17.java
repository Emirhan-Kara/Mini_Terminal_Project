...
public class Project1_Group17 {
    ...
    public static void greetingPage() {
        ...
        String[] part3 = {
                " _   _    _ __   ______  _   _ _   _ _   _ ___ ____    _       ____    ___     ______    _    ____  ",
                "| | | |  / \\\\ \\ / /  _ \\| | | | \\ | | \\ | |_ _/ ___|  / \\     / ___|  / \\ \\   / /  _ \\  / \\  |  _ \\ ",
                "| |_| | / _ \\\\ V /| |_) | | | |  \\| |  \\| || |\\___ \\ / _ \\   | |     / _ \\ \\ / /| | | |/ _ \\ | |_) |",
                "|  _  |/ ___ \\| | |  _ <| |_| | |\\  | |\\  || | ___) / ___ \\  | |___ / ___ \\ V / | |_| / ___ \\|  _ < ",
                "|_| |_/_/   \\_\\_| |_| \\_\\\\___/|_| \\_|_| \\_|___|____/_/   \\_\\  \\____/_/   \\_\\_/  |____/_/   \\_\\_| \\_\\"
        };
        ...
        for (String line : part3)
            System.out.println(line);
        beklermisin();
        for (String line : part4)
            System.out.println(line);
        beklermisin();
        for (String line : part5)
            System.out.println(line);
        beklermisin();
        for (String line : part6)
            System.out.println(line);
        beklermisin();
        cls();
        for (String line : part1)
    ...
    public static boolean isValidEntry(String ans, String... Check) {
        // .equals method must be used. Because when we use ==, it compares the their
        // memory references
        for (String c : Check) {
            if (c.equals(ans))
                return true;
    ...
    /**
     * @author Emirhan
     *         Clear screen, simulate a return to home, displays a " . " in every
     *         500 ms
